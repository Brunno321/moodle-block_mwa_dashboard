...
define(['block_mwa_dashboard/dashboardstore', 'block_mwa_dashboard/engagementcalc'], function(Store, EngagementCalc) {
    ...
    (function () {
      ...
      function statusInfo(score) {
        ...
        if (score > 40) {
          return {key: 'medium', cls: 'medium', color: '#c98a2a', label: tr('ev_med_part', 'Média participação')};
        }
      ...
      function determinantHtml(item) {
        ...
        if (item.score <= 40) {
          ...
          chips.push(detChip(icon('check'), tr('ev_det_rhythm_good', 'Ritmo bom'), 'amber'));
          chips.push(detChip('&#128993;', tr('ev_med_part', 'Média participação'), 'amber'));
        } else {
      ...
      function renderClassKpis(items) {
        ...
        var cards = [
          ...
          ['medium', '&#128993;', tr('ev_med_part', 'Média participação'), counts.medium, 'medium', tr('cl_kpi_tip_medium', 'Alunos com participação de 41% a 69% no curso.'), false],
      ...
      function renderClassFilters(items, filtered) {
        ...
        var filters = [
          ...
          ['medium', tr('ev_med_part', 'Média participação')],
