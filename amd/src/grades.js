    ...
    (function () {
      ...
      function renderGrades() {
        ...
        var approvedHtml = '<div class="gr-card approved" id="grCardApproved">'
          ...
          + '<div class="gr-table-scroll"><table class="gr-tbl gr-approved-table"><thead><tr><th>' + tr('gr_col_student') + '</th><th>' + tr('gr_col_grade') + '</th>' + (hasActGrades ? '<th>' + tr('gr_col_activities') + '</th>' : '') + '</tr></thead><tbody>' + approvedRows + '</tbody></table></div>'
          + '</div>';
        ...
        if (inProg.length) {
          ...
          inProgHtml = '<div class="gr-card inprogress" id="grCardInProgress">'
            ...
            + '<div class="gr-table-scroll"><table class="gr-tbl gr-progress-table"><thead><tr><th>' + tr('gr_col_student') + '</th><th>' + tr('gr_col_current_grade') + '</th><th>' + tr('gr_col_missing') + '</th><th>' + tr('gr_col_progress') + '</th>' + (hasActGrades ? '<th>' + tr('gr_col_activities') + '</th>' : '') + '</tr></thead><tbody>' + ipRows + '</tbody></table></div>'
        ...
        if (noGrade.length) {
          ...
          noGradeHtml = '<div class="gr-card nograde" id="grCardNoGrade">'
            ...
            + '<div class="gr-table-scroll"><table class="gr-tbl gr-nograde-table"><thead><tr><th>' + tr('gr_col_student') + '</th></tr></thead><tbody>' + ngRows + '</tbody></table></div>'
            + '</div>';
        }
