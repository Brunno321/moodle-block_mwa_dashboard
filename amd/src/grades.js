    ...
    (function () {
      ...
      function renderGrades() {
        ...
        function studentCell(g) {
          ...
          return '<button type="button" class="gr-student-link" data-gname="' + esc(g.name) + '" onclick="window.MWAGrades.openProfile(this)">'
        ...
        var filterHtml =
          ...
          + '<div class="gr-filter-row">'
            ...
            + '<div class="gr-filter-group gr-filter-search-group">'
              ...
              + '<label class="gr-search-wrap"><span class="gr-search-icon" aria-hidden="true"><svg class="mwa-ui-icon"><use href="#mwa-icon-search"></use></svg></span><input id="grSearch" type="search" class="gr-search" placeholder="' + esc(tr('gr_search_placeholder')) + '" oninput="window.MWAGrades&&window.MWAGrades.filter()"></label>'
            + '</div>'
        ...
        // ── Approved table ──
        var gradeTableCols = '<colgroup><col class="gr-col-student"><col class="gr-col-grade"><col class="gr-col-missing"><col class="gr-col-progress"><col class="gr-col-activities"></colgroup>';
        var approvedRows = approved.slice().sort(function (a, b) { return pctNorm(b) - pctNorm(a); }).map(function (g, i) {
          ...
          return '<tr data-name="' + esc(g.name).toLowerCase() + '" data-group="approved">'
            ...
            + '<td class="gr-cell-unused" aria-hidden="true"></td>'
            + '<td class="gr-cell-unused" aria-hidden="true"></td>'
            + (hasActGrades && as ? '<td><button class="gr-detail-btn" style="color:' + aColor + ';" data-gname="' + esc(g.name) + '" onclick="event.stopPropagation();window.MWAGrades.showDetailByEl(this)">' + as.graded + '/' + as.total + ' ' + tr('gr_launched') + ' ' + icon('clipboard') + '</button></td>' : '')
            + (!hasActGrades || !as ? '<td class="gr-cell-unused" aria-hidden="true"></td>' : '')
            + '</tr>';
        }).join('');
        ...
        var approvedHtml = '<div class="gr-card approved" id="grCardApproved">'
          ...
          + '<div class="gr-table-scroll"><table class="gr-tbl gr-approved-table">' + gradeTableCols + '<thead><tr><th>' + tr('gr_col_student') + '</th><th>' + tr('gr_col_grade') + '</th><th class="gr-head-unused" aria-hidden="true"></th><th class="gr-head-unused" aria-hidden="true"></th><th>' + tr('gr_col_activities') + '</th></tr></thead><tbody>' + approvedRows + '</tbody></table></div>'
          + '</div>';
        ...
        if (inProg.length) {
          ...
          inProgHtml = '<div class="gr-card inprogress" id="grCardInProgress">'
            ...
            + '<div class="gr-table-scroll"><table class="gr-tbl gr-progress-table">' + gradeTableCols + '<thead><tr><th>' + tr('gr_col_student') + '</th><th>' + tr('gr_col_current_grade') + '</th><th>' + tr('gr_col_missing') + '</th><th>' + tr('gr_col_progress') + '</th><th>' + tr('gr_col_activities') + '</th></tr></thead><tbody>' + ipRows + '</tbody></table></div>'
        ...
        if (noGrade.length) {
          var ngRows = noGrade.map(function (g) {
            ...
            return '<tr data-name="' + esc(g.name).toLowerCase() + '" data-group="nograde">'
              ...
              + '<td class="gr-cell-unused" aria-hidden="true"></td>'
              + '<td class="gr-cell-unused" aria-hidden="true"></td>'
              + (hasActGrades && as ? '<td><button class="gr-detail-btn" style="color:' + aColor + ';" data-gname="' + esc(g.name) + '" onclick="event.stopPropagation();window.MWAGrades.showDetailByEl(this)">' + as.graded + '/' + as.total + ' ' + tr('gr_launched') + ' ' + icon('clipboard') + '</button></td>' : '<td class="gr-cell-unused" aria-hidden="true"></td>')
              + '</tr>';
          }).join('');
          noGradeHtml = '<div class="gr-card nograde" id="grCardNoGrade">'
            ...
            + '<div class="gr-table-scroll"><table class="gr-tbl gr-nograde-table">' + gradeTableCols + '<thead><tr><th>' + tr('gr_col_student') + '</th><th>' + tr('gr_col_grade') + '</th><th class="gr-head-unused" aria-hidden="true"></th><th class="gr-head-unused" aria-hidden="true"></th><th>' + tr('gr_col_activities') + '</th></tr></thead><tbody>' + ngRows + '</tbody></table></div>'
            + '</div>';
        }
      ...
      function showDetail(name, evt) {
        ...
        Store.renderHtml(overlay, '<div class="gr-modal">'
            + '<div class="gr-modal-head">'
              ...
              + '<button class="gr-modal-close" onclick="document.getElementById(\'grDetailModal\').remove()" aria-label="Fechar">' + icon('close') + '</button>'
            + '</div>'
            + '<div class="gr-modal-body"><div class="gr-color-legend">'
            ...
            + '</div>' + (rows || '<p style="color:var(--muted);text-align:center;">' + esc(tr('no_data')) + '</p>') + '</div>'
          + '</div>');
