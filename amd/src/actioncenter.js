...
define(['block_mwa_dashboard/dashboardstore', 'core/templates'], function(Store, Templates) {
    ...
    function attentionItemsHtml(items){
      ...
      if(extra>0){
        html+='<div class="ac-item-row ac-item-more-row"><button type="button" class="ac-item-more" data-action-page="activities">+'+extra+' '+esc(tr('ac_more_activities','mais'))+'</button></div>';
      }
      html+='</div>';
