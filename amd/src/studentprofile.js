...
function(Store, EngagementCalc, ActionCenter, Templates, Chart) {
    ...
    (function () {
      ...
      function loadProfile(name) {
        ...
        var isFollowup = !!(ActionCenter && ActionCenter.isFollowUpStudent && ActionCenter.isFollowUpStudent(rosterStudent));
        var grade = null;
        if (grades.length) {
          grades.some(function (g) {
      ...
      function render() {
          ...
          if (suggestions) {
            ...
            if (query) {
              matches.slice(0, 30).forEach(function(n) {
                ...
                suggestion.value = n;
                suggestion.label = getEmailForStudent(n, d.logs, d.grades, d.students);
        ...
        if (search && !search.dataset.spSearchInit) {
          ...
          search.addEventListener('input', function() {
            var matchedStudent = fillSelect('', search.value);
            loadProfile(matchedStudent);
          });
          search.addEventListener('change', function() {
            var matchedStudent = fillSelect(search.value, search.value);
            loadProfile(matchedStudent);
          });
        }
