...
define(['block_mwa_dashboard/dashboardstore'], function(Store) {
    ...
    (function () {
      ...
      function renderAlertKPIs(d) {
        ...
        var kpiDeltas=[alDelta(d.neverAccessed,true),alDelta(d.sawNotSubmit,true),alDelta(d.sharpDrop,true),alDelta(d.symbolic,true),alDelta(d.reactivated,false)];
      ...
      function renderSmartAlerts(badgeOnly) {
        ...
        var total = d.sawNotSubmit.length + d.sharpDrop.length
