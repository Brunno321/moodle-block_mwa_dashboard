...
class provider implements
     ...
     *
     * Four internal database tables retain user data within Moodle.
    ...
    public static function get_metadata(collection $collection): collection {
        ...
        $collection->add_external_location_link(
            ...
            [
                ...
                'forum_posts_anonymised' => 'privacy:metadata:external:ia:forum_posts_anonymised',
                'question_text_only'     => 'privacy:metadata:external:ia:question_text_only',
                'question_answer_key'    => 'privacy:metadata:external:ia:question_answer_key',
            ],
