...
class dashboard_page implements renderable, templatable {
    ...
    public function require_assets(\moodle_page $page): void {
        $page->requires->js(new \moodle_url('https://cdn.jsdelivr.net/npm/chart.js@4.4.1/dist/chart.umd.js'), true);
    ...
    protected function string_keys(): array {
        return [
            ...
            'msg_no_email', 'msg_conn_error', 'msg_delete_confirm', 'msg_deleted',
