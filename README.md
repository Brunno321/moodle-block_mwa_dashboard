...
### Class
Main student monitoring area. Lists the students in the active Moodle group — including those who have not yet accessed Moodle — with engagement score, participation label, graded-activity and content/resource progress, interactions, and expandable cards with AI recommendations, individual evolution reports, and quick message actions.
